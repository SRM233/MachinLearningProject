...
## Dataset
Training: Daily Grass Minimum Temperature All Year - Hong Kong Observatory (daily_HKO_GMT_ALL.csv) \
Testing: Daily Grass Minimum Temperature Current Year - Hong Kong Observatory (daily_HKO_GMT_2025.csv)
## Requirements
numpy 2.1.2 \
pandas 2.2.3 \
matplotlib 3.9.2 \
